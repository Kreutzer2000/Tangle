 ...
 */
export declare const createGetTransfers: (provider: Provider, caller?: string | undefined) => (seed: string, options?: Partial<GetTransfersOptions>, callback?: Callback<readonly (readonly Transaction[])[]> | undefined) => Promise<readonly (readonly Transaction[])[]>;
