...
ava_1["default"]('prepareTransfers() throws intuitive error when provided invalid transfers array', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        t.is(t.throws(function () { return prepareTransfers('SEED', invalidTransfer); }).message, "Invalid transfer array: " + guards_1.stringify(invalidTransfer), 'prepareTransfers() should throw intuitive error when provided invalid transfers array');
        return [2 /*return*/];
    });
}); });
ava_1["default"]('prepareTransfers() throws error for inputs without security level.', function (t) { return __awaiter(_this, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        }).message, "Invalid input: " + guards_1.stringify(input), 'prepareTransfers() should throw error for inputs without security level.');
        return [2 /*return*/];
    });
}); });
