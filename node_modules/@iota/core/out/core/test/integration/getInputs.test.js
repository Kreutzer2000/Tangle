...
ava_1["default"]('hasSufficientBalance() throws error for insufficient balance', function (t) {
    t.is(t.throws(function () { return createGetInputs_1.hasSufficientBalance(inputs, 110); }, { instanceOf: Error }).message, "" + errors_1.INSUFFICIENT_BALANCE, 'hasSufficientBalance() should throw error for insufficient balance');
});
...
ava_1["default"]('getInputs() rejects with correct errors for invalid input', function (t) {
    ...
    t.is(t.throws(function () { return getInputs(invalidSeed); }, { instanceOf: Error }).message, errors_1.INVALID_SEED + ": " + guards_1.stringify(invalidSeed), 'getInputs() should throw correct error for invalid seed');
    t.is(t.throws(function () { return getInputs(seed, invalidStartEndOptions); }, { instanceOf: Error }).message, errors_1.INVALID_START_END_OPTIONS + ": " + guards_1.stringify(invalidStartEndOptions), 'getInputs() should throw correct error for invalid start & end options');
});
