...
ava_1["default"]('getNewAddress() rejects with correct errors for invalid arguments', function (t) {
    ...
    t.is(t.throws(function () { return getNewAddress(invalidSeed, { index: 0 }); }, { instanceOf: Error }).message, errors_1.INVALID_SEED + ": " + guards_1.stringify(invalidSeed), 'getNewAddress() should throw correct error for invalid seed');
});
ava_1["default"]('getNewAddress() rejects with correct errors for `total=0`', function (t) {
    t.is(t.throws(function () { return getNewAddress(samples_1.seed, { index: 0, total: 0 }); }, { instanceOf: Error }).message, errors_1.INVALID_TOTAL_OPTION + ": " + guards_1.stringify(0), 'getNewAddress() should throw correct error for `total=0`');
});
    ...
    return __generator(this, function (_g) {
        switch (_g.label) {
            ...
            case 2:
                ...
                _f = (_e = t).deepEqual;
                return [4 /*yield*/, isAddressUsed(samples_1.addresses[2])];
            case 3:
                _f.apply(_e, [_g.sent(),
