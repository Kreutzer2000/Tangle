...
ava_1["default"]('storeAndBroadcast() rejects with correct error for invalid attached trytes.', function (t) {
    ...
    t.is(t.throws(function () { return storeAndBroadcast(invalidTrytes); }, { instanceOf: Error }).message, errors_1.INVALID_ATTACHED_TRYTES + ": " + guards_1.stringify(invalidTrytes), 'storeAndBroadcast() should throw error for invalid attached trytes.');
});
ava_1["default"]('storeAndBroadcast() rejects with correct errors for attached trytes of invalid length.', function (t) {
    t.is(t.throws(function () { return storeAndBroadcast(samples_1.attachedTrytesOfInvalidLength); }, { instanceOf: Error }).message, errors_1.INVALID_ATTACHED_TRYTES + ": " + guards_1.stringify(samples_1.attachedTrytesOfInvalidLength), 'storeAndBroadcast() should throw error for attached trytes of invalid length.');
});
