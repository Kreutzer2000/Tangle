...
const client_method_handler_1 = require("./client-method-handler");
const client_1 = require("../types/client");
const block_1 = require("../types/block");
const types_1 = require("../types");
const api_1 = require("../types/models/api");
...
class Client {
     ...
     */
    constructor(options) {
        this.methodHandler = new client_method_handler_1.ClientMethodHandler(options);
    }
    async destroy() {
     ...
     */
    async outputIds(queryParameters) {
        const response = await this.methodHandler.callMethod({
            name: 'outputIds',
            data: {
                queryParameters,
    ...
    async getOutput(outputId) {
        ...
        return (0, class_transformer_1.plainToInstance)(api_1.OutputResponse, parsed.payload);
    }
    /**
    ...
    async buildAndPostBlock(secretManager, options) {
        ...
        const parsed = JSON.parse(response);
        const block = (0, class_transformer_1.plainToInstance)(block_1.Block, parsed.payload[1]);
    ...
    async getBlock(blockId) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.Block, parsed.payload);
    }
    /**
    ...
    async findInputs(addresses, amount) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(types_1.UTXOInput, parsed.payload);
    }
    /**
    ...
    async prepareTransaction(secretManager, options) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(client_1.PreparedTransactionData, parsed.payload);
    }
    /**
     * Sign a transaction.
     *
    ...
    async signTransaction(secretManager, preparedTransactionData) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.TransactionPayload, parsed.payload);
    }
    /**
     ...
     */
    async signatureUnlock(secretManager, transactionEssenceHash, chain) {
        const response = await this.methodHandler.callMethod({
        ...
        return block_1.UnlockCondition.parse(JSON.parse(response).payload);
    }
    /**
    ...
    async getMilestoneById(milestoneId) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.MilestonePayload, parsed.payload);
    }
    /**
    ...
    async getReceipts() {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(api_1.ReceiptsResponse, parsed.payload);
    }
    /**
    ...
    async getTreasury() {
        ...
        return block_1.Output.parse(JSON.parse(response).payload);
    }
    /**
     ...
     */
    async getOutputsIgnoreErrors(outputIds) {
        const response = await this.methodHandler.callMethod({
    ...
    async retryUntilIncluded(blockId, interval, maxAttempts) {
        ...
        parsed.payload.forEach((payload) => {
            arr.push([payload[0], (0, class_transformer_1.plainToInstance)(block_1.Block, payload[1])]);
        });
        return arr;
    }
    /**
    ...
    async buildBasicOutput(params) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.BasicOutput, parsed.payload);
    }
    /**
    ...
    async buildAliasOutput(params) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.AliasOutput, parsed.payload);
    }
    /**
     ...
     */
    async buildFoundryOutput(params) {
        if (params.amount && typeof params.amount === 'bigint') {
            params.amount = params.amount.toString(10);
        }
        const response = await this.methodHandler.callMethod({
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.FoundryOutput, parsed.payload);
    }
    /**
     * Build an NFT output.
     *
    ...
    async buildNftOutput(params) {
        ...
        const parsed = JSON.parse(response);
        return (0, class_transformer_1.plainToInstance)(block_1.NftOutput, parsed.payload);
    }
    /**
     ...
     */
    async listenMqtt(topics, callback) {
     ...
     */
    async clearMqttListeners(topics) {
     ...
     */
    async callPluginRoute(basePluginPath, method, endpoint, queryParams, request) {
        const response = await this.methodHandler.callMethod({
