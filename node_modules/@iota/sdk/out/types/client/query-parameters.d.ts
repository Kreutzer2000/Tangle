 ...
 */
export type QueryParameter = Address | AliasAddress | HasStorageDepositReturn | StorageDepositReturnAddress | HasTimelock | TimelockedBefore | TimelockedAfter | HasExpiration | ExpiresBefore | ExpiresAfter | ExpirationReturnAddress | Sender | Tag | Issuer | StateController | Governor | UnlockableByAddress | CommonQueryParameters;
/** Query parameters for filtering Alias Outputs */
export type AliasQueryParameter = StateController | Governor | Issuer | Sender | UnlockableByAddress | CommonQueryParameters;
...
export type NftQueryParameter = Address | HasStorageDepositReturn | StorageDepositReturnAddress | HasTimelock | TimelockedBefore | TimelockedAfter | HasExpiration | ExpiresBefore | ExpiresAfter | ExpirationReturnAddress | Issuer | Sender | Tag | UnlockableByAddress | CommonQueryParameters;
/** Shared query parameters*/
type CommonQueryParameters = HasNativeTokens | MinNativeTokenCount | MaxNativeTokenCount | CreatedAfter | CreatedBefore | PageSize | Cursor;
/** Query parameters for filtering alias/basic/NFT/foundry Outputs*/
export type GenericQueryParameter = UnlockableByAddress | HasNativeTokens | MinNativeTokenCount | MaxNativeTokenCount | CreatedAfter | CreatedBefore | PageSize | Cursor;
