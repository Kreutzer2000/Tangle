...
export declare class IndexerPluginClient {
     ...
     * @returns The output.
     */
    alias(aliasId: HexEncodedString): Promise<IOutputsResponse>;
    /**
     ...
     * @returns The output.
     */
    nft(nftId: HexEncodedString): Promise<IOutputsResponse>;
    /**
     ...
     * @returns The output.
     */
    foundry(foundryId: HexEncodedString): Promise<IOutputsResponse>;
}
